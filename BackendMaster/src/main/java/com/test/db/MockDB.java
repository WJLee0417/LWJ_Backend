...
public class MockDB {
    ...
    static {
        ...
        boardTable.put(boardSeq, new Board(boardSeq++, "📚 [학습 기록] 1. Servlet (서블릿) 핵심 정리", 
        ...
        boardTable.put(boardSeq, new Board(boardSeq++, "📚 [학습 기록] 2. JSP 개념 및 동작 원리 완벽 해부", 
        ...
        boardTable.put(boardSeq, new Board(boardSeq++, "📚 [학습 기록] 3. Session & Cookie (HTTP의 기억상실증 극복)", 
        ...
        boardTable.put(boardSeq, new Board(boardSeq++, "📚 [학습 기록] 4. EL과 JSTL (JSP 화면 로직 분리)", 
        ...
        boardTable.put(boardSeq, new Board(boardSeq++, "📚 [학습 기록] 5. Filter & Listener (보안과 전역 제어)", 
